...
typedef boost::function<void (boost::shared_ptr<request>, boost::shared_ptr<boost::asio::ip::tcp::socket>) > RequestHandler;
...
public:
  ...
  static void async_write(boost::shared_ptr<boost::asio::ip::tcp::socket> socket, boost::shared_ptr<reply> reply, WriteHandler write_handler);
  static void close(boost::shared_ptr<boost::asio::ip::tcp::socket> socket, boost::system::error_code ec);
